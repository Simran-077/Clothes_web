...
function headerTypeChange($header){
	...
	var $this = $(this),
		...
		switch($header){
			...
			case "header-home1" :
				url = "{{ asset('website') }}/header/header1-container.html";
				type = 'type_1';
				headerStyle ='css/header1.css';
				break;

			case "header-home2" :
				url = "{{ asset('website') }}/header/header2-container.html";
				type = 'type_2';
				headerStyle ='css/header2.css';
				break;

			case "header-home3" :
				url = "{{ asset('website') }}/header/header3-container.html";
				type = 'type_3';
				headerStyle ='css/header3.css';
				break;

			case "header-home4" :
				url = "{{ asset('website') }}/header/header4-container.html";
				type = 'type_4';
				headerStyle ='css/header4.css';
				break;
			
			case "header-home5" :
				url = "{{ asset('website') }}/header/header5-container.html";
				type = 'type_5';
				headerStyle ='website/css/header5.css';
				break;
				
			case "header-home6" :
				url = "{{ asset('website') }}/header/header6-container.html";
				type = 'type_6';
				headerStyle ='css/header6.css';
				break;
			
			case "header-home7" :
				url = "{{ asset('website') }}/header/header7-container.html";
				type = 'type_7';
				headerStyle ='css/header7.css';
				break;
			
			case "header-home8" :
				url = "{{ asset('website') }}/header/header8-container.html";
				type = 'type_8';
